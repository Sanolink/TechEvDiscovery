...
LootJS.modifiers((event) => {
    ...
    replaceLT(['eidolon:silver_ore', 'immersiveengineering:ore_silver', 'darkerdepths:limestone_silver_ore', 'darkerdepths:aridrock_silver_ore', 'darkerdepths:silver_ore', 'iceandfire:silver_ore', 'occultism:silver_ore'], 'alltheores:silver_ore')
    ...
    replaceLT(['eidolon:deep_silver_ore', 'immersiveengineering:deepslate_ore_silver', 'iceandfire:deepslate_silver_ore', 'occultism:silver_ore_deepslate'], 'alltheores:deepslate_silver_ore')
    ...
    replaceLT(['eidolon:raw_silver', 'immersiveengineering:raw_silver', 'darkerdepths:raw_silver', 'occultism:raw_silver'], 'alltheores:raw_silver')
    ...
    replaceLT(['#forge:storage_blocks/raw_silver', 'eidolon:raw_silver_block', 'immersiveengineering:raw_block_silver', 'darkerdepths:raw_silver_block'], 'alltheores:raw_silver_block')
    ...
    replaceLT(['#forge:ingots/silver', 'eidolon:silver_ingot', 'immersiveengineering:ingot_silver', 'darkerdepths:silver_ingot', 'iceandfire:silver_ingot', 'occultism:silver_ingot'], 'alltheores:silver_ingot')
    ...
    //Gears
    replaceLT(['#forge:gears/iron', 'industrialforegoing:iron_gear'], 'alltheores:iron_gear')
    replaceLT(['#forge:gears/gold', 'industrialforegoing:gold_gear'], 'alltheores:gold_gear')
    replaceLT(['#forge:gears/diamond', 'industrialforegoing:diamond_gear'], 'alltheores:diamond_gear')
    //Rods
    ...
    replaceLT(['#forge:nuggets/silver', 'eidolon:silver_nugget', 'immersiveengineering:nugget_silver', 'iceandfire:silver_nugget', 'occultism:silver_nugget'], 'alltheores:silver_nugget')
    ...
    replaceLT(['#forge:storage_blocks/silver', 'immersiveengineering:storage_silver', 'eidolon:silver_block', 'darkerdepths:silver_block', 'iceandfire:silver_block', 'occultism:silver_block'], 'alltheores:silver_block')
