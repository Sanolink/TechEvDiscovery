...
LootJS.modifiers((event) => {
    ...
    replaceLT(['eidolon:lead_ore', 'immersiveengineering:ore_lead', 'thermal:lead_ore', 'mekanism:lead_ore'], 'alltheores:lead_ore')
    ...
    replaceLT(['immersiveengineering:ore_uranium', 'mekanism:uranium_ore'], 'alltheores:uranium_ore')
    replaceLT(['mekanism:osmium_ore'], 'alltheores:osmium_ore')
    replaceLT(['thermal:tin_ore', 'mekanism:tin_ore'], 'alltheores:tin_ore')
    
    //Deepslate Ores
    replaceLT(['create:deepslate_zinc_ore'], 'alltheores:deepslate_zinc_ore')
    replaceLT(['eidolon:deep_lead_ore', 'immersiveengineering:deepslate_ore_lead', 'thermal:deepslate_lead_ore', 'mekanism:deepslate_lead_ore'], 'alltheores:deepslate_lead_ore')
    ...
    replaceLT(['immersiveengineering:deepslate_ore_uranium', 'mekanism:deepslate_uranium_ore'], 'alltheores:deepslate_uranium_ore')
    replaceLT(['mekanism:deepslate_osmium_ore'], 'alltheores:deepslate_osmium_ore')
    replaceLT(['thermal:deepslate_tin_ore', 'mekanism:deepslate_tin_ore'], 'alltheores:deepslate_tin_ore')

    //Raw Materials
    replaceLT(['create:raw_zinc'], 'alltheores:raw_zinc')
    replaceLT(['eidolon:raw_lead', 'immersiveengineering:raw_lead', 'thermal:raw_lead', 'mekanism:raw_lead'], 'alltheores:raw_lead')
    ...
    replaceLT(['immersiveengineering:raw_uranium', 'mekanism:raw_uranium'], 'alltheores:raw_uranium')
    replaceLT(['mekanism:raw_osmium'], 'alltheores:raw_osmium')
    replaceLT(['thermal:raw_tin', 'mekanism:raw_tin'], 'alltheores:raw_tin')
    ...
    replaceLT(['#forge:ingots/bronze', 'thermal:bronze_ingot', 'mekanism:ingot_bronze'], 'alltheores:bronze_ingot')
    ...
    replaceLT(['#forge:ingots/lead', 'eidolon:lead_ingot', 'immersiveengineering:ingot_lead', 'thermal:lead_ingot', 'mekanism:ingot_lead'], 'alltheores:lead_ingot')
    ...
    replaceLT(['#forge:ingots/osmium', 'mekanism:ingot_osmium'], 'alltheores:osmium_ingot')
    ...
    replaceLT(['#forge:ingots/tin', 'thermal:tin_ingot', 'mekanism:ingot_tin'], 'alltheores:tin_ingot')
    replaceLT(['#forge:ingots/uranium', 'immersiveengineering:ingot_uranium', 'mekanism:ingot_uranium'], 'alltheores:uranium_ingot')
    ...
    replaceLT(['#forge:plates/iron', 'create:iron_sheet', 'immersiveengineering:plate_iron', 'thermal:iron_plate', 'ad_astra:iron_plate'], 'alltheores:iron_plate')
    ...
    replaceLT(['#forge:nuggets/bronze', 'thermal:bronze_nugget', 'mekanism:nugget_bronze'], 'alltheores:bronze_nugget')
    ...
    replaceLT(['#forge:nuggets/lead', 'eidolon:lead_nugget', 'immersiveengineering:nugget_lead', 'thermal:lead_nugget', 'mekanism:nugget_lead'], 'alltheores:lead_nugget')
    ...
    replaceLT(['#forge:nuggets/osmium', 'mekanism:nugget_osmium'], 'alltheores:osmium_nugget')
    ...
    replaceLT(['#forge:nuggets/tin', 'thermal:tin_nugget', 'mekanism:nugget_tin'], 'alltheores:tin_nugget')
    replaceLT(['#forge:nuggets/uranium', 'immersiveengineering:nugget_uranium', 'mekanism:nugget_uranium'], 'alltheores:uranium_nugget')
    ...
    replaceLT(['#forge:dusts/bronze', 'thermal:bronze_dust', 'mekanism:dust_bronze'], 'alltheores:bronze_dust')
    replaceLT(['#forge:dusts/constantan', 'immersiveengineering:dust_constantan', 'thermal:constantan_dust'], 'alltheores:constantan_dust')
    replaceLT(['#forge:dusts/copper', 'immersiveengineering:dust_copper', 'occultism:copper_dust', 'thermal:copper_dust', 'mekanism:dust_copper'], 'alltheores:copper_dust')
    replaceLT(['#forge:dusts/diamond', 'createaddition:diamond_grit', 'thermal:diamond_dust', 'mekanism:dust_diamond'], 'alltheores:diamond_dust')
    ...
    replaceLT(['#forge:dusts/gold', 'immersiveengineering:dust_gold', 'occultism:gold_dust', 'thermal:gold_dust', 'mekanism:dust_gold'], 'alltheores:gold_dust')
    replaceLT(['#forge:dusts/invar', 'thermal:invar_dust'], 'alltheores:invar_dust')
    replaceLT(['#forge:dusts/iron', 'immersiveengineering:dust_iron', 'occultism:iron_dust', 'thermal:iron_dust', 'mekanism:dust_iron'], 'alltheores:iron_dust')
    replaceLT(['#forge:dusts/lapis', 'mekanism:dust_lapis_lazuli'], 'thermal:lapis_dust')
    replaceLT(['#forge:dusts/lead', 'immersiveengineering:dust_lead', 'thermal:lead_dust', 'mekanism:dust_lead'], 'alltheores:lead_dust')
    ...
    replaceLT(['#forge:dusts/obsidian', 'occultism:obsidian_dust', 'mekanism:dust_obsidian'], 'occultism:obsidian_dust')
    replaceLT(['#forge:dusts/osmium', 'mekanism:dust_osmium'], 'alltheores:osmium_dust')
    ...
    replaceLT(['#forge:dusts/sulfur', 'immersiveengineering:dust_sulfur', 'eidolon:sulfur', 'mekanism:dust_sulfur'], 'thermal:sulfur_dust')
    replaceLT(['#forge:dusts/tin', 'thermal:tin_dust', 'mekanism:dust_tin'], 'alltheores:tin_dust')
    replaceLT(['#forge:dusts/uranium', 'immersiveengineering:dust_uranium', 'mekanism:dust_uranium'], 'alltheores:uranium_dust')
    ...
    replaceLT(['#forge:storage_blocks/bronze', 'thermal:bronze_block', 'mekanism:block_bronze'], 'alltheores:bronze_block')
    ...
    replaceLT(['#forge:storage_blocks/tin', 'thermal:tin_block', 'mekanism:block_tin'], 'alltheores:tin_block')
    replaceLT(['#forge:storage_blocks/uranium', 'immersiveengineering:storage_uranium', 'mekanism:block_uranium'], 'alltheores:uranium_block')
