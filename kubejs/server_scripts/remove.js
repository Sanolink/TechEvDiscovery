...
ServerEvents.recipes(event => {
    ...
    event.remove({ id: 'projectexpansion:collector/compressed/basic'})
    event.remove({ id: 'projectexpansion:collector/compressed/dark'})
    event.remove({ id: 'projectexpansion:collector/compressed/red'})
    event.remove({ id: 'projectexpansion:collector/compressed/magenta'})
    event.remove({ id: 'projectexpansion:collector/compressed/pink'})
    event.remove({ id: 'projectexpansion:collector/compressed/purple'})
    event.remove({ id: 'projectexpansion:collector/compressed/violet'})
    event.remove({ id: 'projectexpansion:collector/compressed/blue'})
    event.remove({ id: 'projectexpansion:collector/compressed/cyan'})
    event.remove({ id: 'projectexpansion:collector/compressed/green'})
    event.remove({ id: 'projectexpansion:collector/compressed/lime'})
    event.remove({ id: 'projectexpansion:collector/compressed/yellow'})
    event.remove({ id: 'projectexpansion:collector/compressed/orange'})
    event.remove({ id: 'projectexpansion:collector/compressed/white'})
    event.remove({ id: 'projectexpansion:collector/compressed/fading'})
    event.remove({ id: 'projectexpansion:collector/compressed/final'})
