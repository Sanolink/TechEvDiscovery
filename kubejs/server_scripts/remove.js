...
ServerEvents.recipes(event => {
    ...
    event.remove({ id: 'ftbic:shaped/ingots/bronze_to_bronze_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/lead_to_lead_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/lead_to_lead_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/enderium_to_enderium_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/enderium_to_enderium_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/uranium_to_uranium_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/uranium_to_uranium_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/aluminum_to_aluminum_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/aluminum_to_aluminum_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/tin_to_tin_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/tin_to_tin_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/iridium_to_iridium_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/iridium_to_iridium_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/copper_to_copper_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/copper_to_copper_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/gold_to_gold_rod'})
    event.remove({ id: 'ftbic:shaped/ingots/gold_to_gold_gear'})
    event.remove({ id: 'ftbic:shaped/ingots/iron_to_iron_rod'})
    ...
    event.remove({ id: 'productivebees:botania/pure_bee'})
    ...
    event.remove({ id: 'productivebees:cofh/machine/smelter/glowing_bee_to_energized_glowstone_bee'})
    ...
    event.remove({ id: 'productivebees:cofh/shaped/glowing_bee_to_energized_glowstone_bee'})
    ...
    event.remove({ id: 'productivebees:ftbic/canning/iridium_bee'})
    ...
    event.remove({ id: 'productivebees:mysticalagriculture/inferium_bee'})
    event.remove({ id: 'productivebees:mysticalagriculture/insanium_bee'})
    event.remove({ id: 'productivebees:mysticalagriculture/prudentium_bee'})
    ...
    event.remove({ id: 'productivebees:powah/spirited_crystal_bee'})
