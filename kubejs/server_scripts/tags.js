...
ServerEvents.tags('item', e => {
    ...
    e.remove('forge:ores/silver', 'eidolon:silver_ore', 'immersiveengineering:ore_silver')
    ...
    e.remove('forge:raw_materials/silver', 'eidolon:raw_silver', 'immersiveengineering:raw_silver')
    ...
    e.remove('forge:storage_blocks/raw_silver', 'eidolon:raw_silver_block', 'immersiveengineering:raw_block_silver')
    ...
    e.remove('forge:ingots/silver', ['eidolon:silver_ingot', 'immersiveengineering:ingot_silver'])
    ...
    e.remove('forge:storage_blocks/silver', 'immersiveengineering:storage_silver', 'eidolon:silver_block')
    //Wires
