...
ServerEvents.tags('item', e => {
    ...
    e.remove('forge:ingots/chromium', 'chemlib:chromium_ingot')
    ...
    e.remove('forge:ingots/titanium', 'chemlib:titanium_ingot')
    e.remove('forge:ingots/tungsten', 'chemlib:tungsten_ingot')
    ...
    e.remove('forge:nuggets/chromium', 'chemlib:chromium_nugget')
    ...
    e.remove('forge:nuggets/titanium', 'chemlib:titanium_nugget')
    e.remove('forge:nuggets/tungsten', 'chemlib:tungsten_nugget')
    ...
    e.remove('forge:dusts/chromium', 'chemlib:chromium_dust')
    ...
    e.remove('forge:dusts/titanium', 'chemlib:titanium_dust')
    e.remove('forge:dusts/tungsten', 'chemlib:tungsten_dust')
    ...
    e.remove('forge:storage_blocks/chromium', 'chemlib:chromium_metal_block')
    ...
    e.remove('forge:storage_blocks/titanium', 'chemlib:titanium_metal_block')
    e.remove('forge:storage_blocks/tungsten', 'chemlib:tungsten_metal_block')
    ...
    e.remove('forge:wires/copper', 'immersiveengineering:wire_copper', 'ftbic:copper_wire')
    ...
    e.add('forge:ingots/overcharged_iron', 'create_new_age:overcharged_iron')
    e.add(`forge:plates/carbon`, 'ftbic:carbon_plate')
    e.add(`forge:plates/experience`, 'create_things_and_misc:experience_sheet')
    e.add(`forge:plates/rose_quartz`, 'create_things_and_misc:rose_quartz_sheet')
    e.add('forge:plates/overcharged_gold', 'create_new_age:overcharged_golden_sheet')
    e.add('forge:plates/overcharged_iron', 'create_new_age:overcharged_iron_sheet')
