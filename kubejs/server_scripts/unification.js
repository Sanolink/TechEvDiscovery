...
ServerEvents.recipes(e => {
    ...
    RAW_BLOCKS_IE.forEach(I => {
        e.remove({ input: I, type: 'minecraft:crafting_shapeless', mod: "immersiveengineering" })
    ...
    BLOCKS_EIDOLON.forEach(I => {
        e.remove({ input: I, type: 'minecraft:crafting_shapeless', mod: "eidolon" })
    ...
    RAW_BLOCKS_THERMAL.forEach(I => {
         e.remove({ input: I, type: 'minecraft:crafting_shapeless', mod: "thermal" })
