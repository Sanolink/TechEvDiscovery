...
ServerEvents.recipes(e => {
    ...
    ['chemlib:chromium_ingot'].forEach(I => {replaceIO(I, 'alchemistry:chromium_ingot')});
    ...
    ['chemlib:titanium_ingot'].forEach(I => {replaceIO(I, 'alchemistry:titanium_ingot')});
    ['chemlib:tungsten_ingot'].forEach(I => {replaceIO(I, 'alchemistry:tungsten_ingot')});
    ...
    ['chemlib:chromium_nugget'].forEach(I => {replaceIO(I, 'alchemistry:chromium_nugget')});
    ...
    ['chemlib:titanium_nugget'].forEach(I => {replaceIO(I, 'alchemistry:titanium_nugget')});
    ['chemlib:tungsten_nugget'].forEach(I => {replaceIO(I, 'alchemistry:tungsten_nugget')});
    ...
    ['chemlib:chromium_dust'].forEach(I => {replaceIO(I, 'alchemistry:chromium_dust')});
    ...
    ['chemlib:titanium_dust'].forEach(I => {replaceIO(I, 'alchemistry:titanium_dust')});
    ['chemlib:tungsten_dust'].forEach(I => {replaceIO(I, 'alchemistry:tungsten_dust')});
    ...
    ['chemlib:chromium_metal_block'].forEach(I => {replaceIO(I, 'alchemistry:chromium_block')});
    ...
    ['chemlib:titanium_metal_block'].forEach(I => {replaceIO(I, 'alchemistry:titanium_block')});
    ['chemlib:tungsten_metal_block'].forEach(I => {replaceIO(I, 'alchemistry:tungsten_block')});
    ...
    e.remove({ id: 'ad_astra:recipes/copper_ingot_from_blasting_glacio_copper_ore'})
    e.remove({ id: 'ad_astra:recipes/copper_ingot_from_smelting_glacio_copper_ore'})
    e.remove({ id: 'ad_astra:recipes/gold_ingot_from_blasting_venus_gold_ore'})
    e.remove({ id: 'ad_astra:recipes/gold_ingot_from_smelting_venus_gold_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_blasting_glacio_iron_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_blasting_mars_iron_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_blasting_moon_iron_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_smelting_glacio_iron_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_smelting_mars_iron_ore'})
    e.remove({ id: 'ad_astra:recipes/iron_ingot_from_smelting_moon_iron_ore'})
    ...
    e.remove({ id: 'darkerdepths:gold_ingot_from_blasting_aridrock_gold_ore'})
    e.remove({ id: 'darkerdepths:gold_ingot_from_blasting_limestone_gold_ore'})
    e.remove({ id: 'darkerdepths:gold_ingot_from_smelting_aridrock_gold_ore'})
    e.remove({ id: 'darkerdepths:gold_ingot_from_smelting_limestone_gold_ore'})
    e.remove({ id: 'darkerdepths:iron_ingot_from_blasting_aridrock_iron_ore'})
    e.remove({ id: 'darkerdepths:iron_ingot_from_blasting_limestone_iron_ore'})
    e.remove({ id: 'darkerdepths:iron_ingot_from_smelting_aridrock_iron_ore'})
    e.remove({ id: 'darkerdepths:iron_ingot_from_smelting_limestone_iron_ore'})
    ...
    e.remove({ id: 'undergarden:blast_depthrock_gold_ore'})
    e.remove({ id: 'undergarden:blast_depthrock_iron_ore'})
    e.remove({ id: 'undergarden:blast_shiverstone_iron_ore'})
    e.remove({ id: 'undergarden:smelt_depthrock_gold_ore'})
    e.remove({ id: 'undergarden:smelt_depthrock_iron_ore'})
    e.remove({ id: 'undergarden:smelt_shiverstone_iron_ore'})
