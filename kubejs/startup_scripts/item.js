...
StartupEvents.registry('item', e => {
    ...
    BasicItem('ad_astra:calorite_rod', "Calorite Rod").tag("forge:rods").tag(`forge:rods/calorite`)
    ...
    BasicItem('ad_astra:desh_rod', "Desh Rod").tag("forge:rods").tag(`forge:rods/desh`)
    ...
    BasicItem('ad_astra:nephryx_rod', "Nephryx Rod").tag("forge:rods").tag(`forge:rods/nephryx`)
    ...
    BasicItem('ad_astra:ostrum_rod', "Ostrum Rod").tag("forge:rods").tag(`forge:rods/ostrum`)
    ...
    BasicItem('blue_skies:falsite_rod', "Falsite Rod").tag("forge:rods").tag(`forge:rods/falsite`)
    ...
    BasicItem('blue_skies:ventium_rod', "Ventium Rod").tag("forge:rods").tag(`forge:rods/ventium`)
    ...
    BasicItem('blue_skies:horizonite_rod', "Horizonite Rod").tag("forge:rods").tag(`forge:rods/horizonite`)
    ...
    BasicItem('botania:elementium_rod', "Elementium Rod").tag("forge:rods").tag(`forge:rods/elementium`)
    ...
    BasicItem('create_new_age:overcharged_iron_rod', "Overcharged Iron Rod").tag("forge:rods").tag(`forge:rods/overcharged_iron`)
    ...
    BasicItem('create_new_age:overcharged_golden_rod', "Overcharged Golden Rod").tag("forge:rods").tag(`forge:rods/overcharged_gold`)
    ...
    BasicItem('createdeco:cast_iron_rod', "Cast Iron Rod").tag("forge:rods").tag(`forge:rods/cast_iron`)
    ...
    BasicItem('eidolon:arcane_gold_rod', "Arcane Gold Rod").tag("forge:rods").tag(`forge:rods/arcane_gold`)
    ...
    BasicItem('occultism:iesnium_rod', "Iesnium Rod").tag("forge:rods").tag(`forge:rods/iesnium`)
    ...
    BasicItem('thermalendergy:prismalium_rod', "Prismalium Rod").tag("forge:rods").tag(`forge:rods/prismalium`)
    BasicItem('thermalendergy:melodium_rod', "Melodium Rod").tag("forge:rods").tag(`forge:rods/melodium`)
    BasicItem('thermalendergy:stellarium_rod', "Stellarium Rod").tag("forge:rods").tag(`forge:rods/stellarium`)
    
    BasicItem('thermal_extra:soul_infused_rod', "Soul Infused Rod").tag("forge:rods").tag(`forge:rods/soul_infused`)
    BasicItem('thermal_extra:shellite_rod', "Shellite Rod").tag("forge:rods").tag(`forge:rods/shellite`)
    BasicItem('thermal_extra:twinite_rod', "Twinite Rod").tag("forge:rods").tag(`forge:rods/twinite`)
    BasicItem('thermal_extra:dragonsteel_rod', "Dragonsteel Rod").tag("forge:rods").tag(`forge:rods/dragonsteel`)
    ...
    BasicItem('undergarden:cloggrum_rod', "Cloggrum Rod").tag("forge:rods").tag(`forge:rods/cloggrum`)
    ...
    BasicItem('undergarden:froststeel_rod', "Froststeel Rod").tag("forge:rods").tag(`forge:rods/froststeel`)
