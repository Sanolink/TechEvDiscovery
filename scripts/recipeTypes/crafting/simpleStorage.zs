...
mods.recipestages.Recipes.addShaped("two", "ct_inventory_remote", <item:storagenetwork:inventory_remote>, [
...
mods.recipestages.Recipes.addShaped("two", "ct_crafting_remote", <item:storagenetwork:crafting_remote>, [
