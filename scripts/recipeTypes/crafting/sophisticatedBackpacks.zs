...
mods.recipestages.Recipes.addShaped("two", "backpack", <item:sophisticatedbackpacks:backpack>, [
...
mods.recipestages.Recipes.addShaped("two", "backpack2", <item:sophisticatedbackpacks:backpack>, [
